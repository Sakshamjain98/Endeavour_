...
const MailComponent = () => {
  ...
  return (
    ...
    <div className="mail-wrapper  mt-24 my-12 w-full  flex  justify-center items-center">
      ...
      <input type="password" name="password" id="" placeholder='Password' className='m-2 p-1 border-black block border-b-2 md:w-[90%]'/>
      <input type="number" name="phonenumber" id="" placeholder='Phone-Number' className='m-2 p-1 border-black block border-b-2 md:w-[90%]'/>
<div className='flex flex-wrap justify-center flex-col md:flex-row items-center gap-5'>

      <button type="submit" className='md:w-[30%] w-[50%] h-8 bg-blue-800 text-white my-2 '>Submit</button>
      <Link to="/login">
      <button type="submit" className='md:w-[120%]  h-8 bg-blue-800 text-white my-2 '>Already have an Account!!</button>
      </Link>
