      ...
      // background: "linear-gradient(to bottom, #c8e1ec,#1a8fbe,#045b95,#7ccce4)",
        ...
        <div className="flex bg-white flex-col md:flex-row border min-h-[100vh] pt-10 justify-center items-center overflow-hidden">
          <div className="w-40% md:w-[50%] flex mt-10 justify-center items-center">
            ...
            <div className="w-[60%]">
          <Landing name="Movie-A-thon" desc="Welcome to Movie-A-thon, where creativity, humour, and feasibility collide! Teams
...
films!"></Landing>
        ...
        <ul className="font-mono text-md ">
          ...
          <li>● The participants should answer within the given time limit.</li>
        ...
        <ul className="font-mono text-md ">
          <li>● Enhances Pitching Skills: Participating in a movie pitch battle hones your
ability to present ideas succinctly and persuasively.</li>
          <li>● Industry Exposure: Offers valuable exposure to industry professionals,
potentially opening doors for collaboration and opportunities.</li>
<li>● Networking Opportunities: Facilitates connections with fellow filmmakers,
producers, and decision-makers, fostering a supportive professional network.</li>
          </ul>
          </div>
          </div>
          <div className="flex flex-col justify-center items-center">
            ...
            <ul className="font-mono text-md ">
          <li>● Participants will receive summaries of screenplays or plots of well-known films
in the form of 5 case studies with predetermined questions.
</li>
          <li>● Teams answer the questions within a time limit of 30 minutes.</li>
          <li>● The top 8 teams with the most number of correct answers progress to the
next round.</li>
            ...
            <ul className="font-mono text-md ">
          <li>● Entrepreneurial Kickoff: Teams initiate their business journey by forming
groups and selecting popular movies like 3 Idiots or Tarzan (The Wonder Car)
for their pitches.
</li>
<li>● Cinematic Analysis: Teams dissect the chosen movie`s climax and plot,
extracting crucial elements to inspire and shape their innovative business
concepts.
</li>
<li>● Movie-Inspired Business Plans: The entrepreneurial plan revolves around
integrating the identified plot and climax elements, providing a unique and
creative foundation for their pitches.
</li>
<li>● You have to name that startup with a tagline.
</li>
