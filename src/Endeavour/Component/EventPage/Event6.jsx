    ...
    <div className="" id="event-1" style={{}}>
      <div className="flex bg-white flex-col md:flex-row border min-h-[100vh] pt-10 justify-center items-center overflow-hidden">
        ...
        <div className="w-[60%]">
          <Landing
            name="Treasure Hunt"
            desc="“Not all treasure silver and gold, mate.” - Jack Sparrow Be a part of our campus
        ...
        <div className=" flex flex-col">
          <div className="flex flex-col">
            <div className="m-8 ">
              ...
              <ul className="font-mono text-md ">
                ...
                <li>
                  ● Passing the answers to other teams is strictly not allowed.
                </li>
                <li>Participants have to maintain the decorum.</li>
                <li>
                  ● All the participants have to follow all the rules of the
                  game.
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="m-8  ">
              ...
              <ul className="font-mono text-md ">
                <li>
                  ● The participants will be provided with clues. The
                ...
                <li>
                  ● All the answers to the clues would be a building or location
                  inside the campus.
                </li>
                <li>
                  ● There will be five tracks in which the team will be
                  participating in this event after solving the clues, teams
                  will reach the three tracks in which there will be three
                  caskets and at last it will end to a single track.
                </li>
                <li>
                  ● At last, the team which solves all the clues in minimum time
                  and reaches the final casket will be the winner.
                </li>
              </ul>
            </div>
          </div>
