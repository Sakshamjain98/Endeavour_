    ...
    <div className="" id="event-1" style={{}}>
      <div className="flex bg-white flex-col md:flex-row border min-h-[100vh] pt-10 justify-center items-center overflow-hidden">
        ...
        <div className="w-[60%]">
          <Landing
            name="B-Plan"
            desc="Ideas abound when you have the conviction to bring about a change around you.
...
up, buddies! Prepare an abstract and showcase it to be a winner."
          ></Landing>
        </div>
      </div>
          ...
          <div className="flex flex-col">
            <div className="m-8 ">
              ...
              <ul className="font-mono text-md ">
                ...
                <li>
                  ● The team without the proper format of the presentation will
                  be disqualified.
                </li>
                <li>● There is no need for laptops for presentations.</li>
                <li>
                  ● The final decision of the judges will not be questionable.
                </li>
                <li>
                  ● Participants should maintain decorum during the event.
                </li>
              </ul>
            </div>
            <div className="m-8 ">
              ...
              <ul className="font-mono text-md ">
                <li>
                  ● To get the idea mentored by entrepreneurs and investors.
                </li>
          ...
          <div className="flex flex-col justify-center items-center">
            <div className="m-8  font-semibold">
              ...
              <p className="text-[1rem] font-serif">
                Participants will be given a Google form through which they will
                have to fill up the questionnaire round, which will consist of
                several subjective questions based on the different aspects of
                the start-up.
              </p>
            </div>
            <div className="m-8 font-semibold">
              ...
              <p className="text-[1rem] font-serif">
                This is the final round. Participants will pitch their ideas
                that they have presented before. There will be 5 minutes
                allotted for the presentation and 2–3 minutes for the
                questionnaire round.
              </p>
            </div>
          </div>
