    ...
    return (
        ...
        >
            ...
            <div className="w-full md:w-[50%] mt-24 md:ml-8 overflow-hidden">
                <h2 className="font-bold text-3xl md:text-5xl mb-8 font-serif text-center md:text-left">About The Event</h2>
                ...
                <h2 className="font-bold text-3xl md:text-5xl mb-8 mt-8 font-serif text-center md:text-left">When & Where</h2>
