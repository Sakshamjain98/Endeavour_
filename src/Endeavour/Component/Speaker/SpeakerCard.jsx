...
function TestimonialCarousel() {
  ...
  const colors = ["c8e1ec","1a8fbe","043e79","040506","5db2cf","045b95","064d81","2b4c53","7ccce4"];
  ...
  return (
    ...
    >
       ...
       <h1 className="text-center  text-6xl m-2  text-blue-600 font-serif font-bold mt-8"
         style={{
          // color: "#5db2cf"
        }}
        id='speaker'
