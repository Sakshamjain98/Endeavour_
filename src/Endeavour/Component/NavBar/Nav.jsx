...
const navigation = [
  ...
  { name: 'Sponsers', href: '/sponser', current: false },
]
...
export default function Example() {
  return (
    <Disclosure as="nav" className=" shadow-lg shadow-slate-500 w-[98%] mx-3  my-1 fixed  rounded-md "
    style={
      {
      ...
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel className="sm:hidden">
            <div className="space-y-1 px-2 pb-3 pt-2 bg-slate-500">
              {navigation.map((item) => (
                <Disclosure.Button
                  key={item.name}
                  as="a"
